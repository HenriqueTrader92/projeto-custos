...
Route::group(['middleware'=>'auth'],function(){
    Route::any('historico-search', 'MovimentacoesController@searchHistorico')->name('historico.search');
    Route::get('historico', 'MovimentacoesController@historico')->name('index.historico');
